...
int main() {
    ...
    if (Factorization::tol == 1) {
        ...
        ll maxPrime = *max_element(Factorization::factor, Factorization::factor + Factorization::tol);
        cout << *upper_bound(EulerPrimeSieve::prime, EulerPrimeSieve::prime + EulerPrimeSieve::num_prime, (int)maxPrime) << '\n';
    }
